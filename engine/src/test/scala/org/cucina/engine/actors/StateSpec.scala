...
import org.cucina.engine.definition.{TransitionDescriptor, OperationDescriptor, ProcessDefinition, Token}
...
with BeforeAndAfter
with MockitoSugar {
  val processContext: ProcessContext = new ProcessContext(new Token(new Object, mock[ProcessDefinition]), new scala.collection.mutable.HashMap[String, Object](), self)
